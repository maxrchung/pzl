...
export const DEFAULT_IMAGE_SIZE = { height: 240, width: 240 };

export const HOME_IMAGE_KEY = 'static/eyes.jpg';
export const HOME_IMAGE_URL = `https://${S3_BUCKET}.s3.us-west-1.amazonaws.com/${HOME_IMAGE_KEY}`;
export const HOME_IMAGE_SIZE = { height: 100, width: 200 };
